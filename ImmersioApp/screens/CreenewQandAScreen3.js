...
return (
  <SafeAreaView style={main.safeAreaContainer}>
      ...
      <View>
        {trackQuestions.one && <View>
            <View style={{flexDirection:'row', alignSelf:'center'}}>
                <Text style={{color:'gray', marginTop:Responsive(40), fontSize:18, marginRight:10}}>Moose Factory</Text>
            ...
            <View style={{alignSelf:'center', marginTop:Responsive(190)}}>
                ...
                <TouchableOpacity onPress={()=>{correctAnswer1(),playCorrectSound()}}
                    ...
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(87)}}>Nitôhcîn</Text>
                </TouchableOpacity>
        ...
        {trackQuestions.two && <View>
            <View style={{flexDirection:'row', alignSelf:'center'}}>
                ...
                <TextInput editable={false} style={{marginRight:Responsive(8),
                                                    ...
                                                    backgroundColor:'#DADADA',
                                                    textAlign:'center',
                                                    borderRadius: 4, color: 'green'}} value={'nitôhcîn'}/>  
            </View>
            ...
            <View style={{alignSelf:'center', marginTop:Responsive(150)}}>
                ...
                <TouchableOpacity onPress={()=>{wrongAnswer2(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor2, borderRadius:4, marginBottom:Responsive(9), padding:8}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Tâni</Text>
                </TouchableOpacity>                
            </View>
        </View>}
        ...
        {trackQuestions.four && <View>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(10)}}>
                <TextInput editable={false} style={{marginHorizontal:Responsive(8),
                                                    ...
                                                    backgroundColor:'#DADADA',
                                                    textAlign:'center',
                                                    borderRadius: 4, color: 'green'}} value={''}/>
                <Text style={{color:'gray', marginTop:Responsive(7), fontSize:18}}>.</Text>                                   
            </View>
            <View style={{alignSelf:'center', marginTop:Responsive(140)}}>
                <TouchableOpacity onPress={()=>{wrongAnswer1(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor1, borderRadius:4, marginBottom:Responsive(9), padding:8}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(55), alignSelf:'center'}}>Tâni e-išinihkâsoyan?</Text>
                </TouchableOpacity>                
                <TouchableOpacity onPress={()=>{wrongAnswer2(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor2, borderRadius:4, marginBottom:Responsive(9), padding:8}}>                    
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Nitôhcîn</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>{correctAnswer4(), playCorrectSound()}} style={{justifyContent:'center', backgroundColor:correctColor4, borderRadius:4, marginBottom:Responsive(9), padding:8}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Kâ</Text>
                </TouchableOpacity>
            </View>
          ...
          <View style={{flexDirection:'row', alignSelf:'center'}}>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(10)}}>
                <TextInput editable={false} style={{marginHorizontal:Responsive(8),
                                                    ...
                                                    backgroundColor:'#DADADA',
                                                    textAlign:'center',
                                                    borderRadius: 4, color: 'green'}} value={'Kâ'}/>
                <Text style={{color:'gray', marginTop:Responsive(7), fontSize:18}}></Text>                                   
            </View>
        </View>}
    ...
    {trackQuestions.done && <View>
            ...
            <Text style={{alignSelf:'center', color:'#F5891C', fontSize:25, marginTop:Responsive(15), fontWeight:'bold'}}>Congratulations!</Text>
