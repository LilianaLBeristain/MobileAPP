        ...
        {trackQuestions.one && <View>
            <View style={{flexDirection:'row', alignSelf:'center'}}>
                ...
                <TextInput editable={false} style={{marginRight:Responsive(8),
                                                    ...
                                                    textAlign:'center',
                                                    borderRadius: 4}}/>    
                <Text style={{color:'gray', marginTop:Responsive(40), fontSize:18}}>Rachel nitišinihkâson.</Text>
            </View>
            <View style={{alignSelf:'center', marginTop:Responsive(190)}}>
                <TouchableOpacity onPress={()=>{correctAnswer1(),playCorrectSound()}}
                    ...
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(87)}}>Wâciye!</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>{wrongAnswer3(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor3, borderRadius:4, marginBottom:Responsive(9), padding:8}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Nešta</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>{wrongAnswer2(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor2, borderRadius:4, marginBottom:Responsive(9), padding:8}}>                    
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Nitišinihkâson</Text>
                </TouchableOpacity>                
        ...
        {trackQuestions.two && <View>
            <View style={{flexDirection:'row', alignSelf:'center'}}>              
                <TextInput editable={false} style={{marginRight:Responsive(8),
                                                    ...
                                                    backgroundColor:'#DADADA',
                                                    textAlign:'center',
                                                    borderRadius: 4, color: 'green'}} value={'Wâciye!'}/>    
                <Text style={{color:'gray', marginTop:Responsive(40), fontSize:18}}>Rachel nitišinihkâson.</Text>
            </View>
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(10)}}>
                <Text style={{color:'gray', marginTop:Responsive(7), fontSize:18}}>Tâni e-</Text>
            ...
            <View style={{alignSelf:'center', marginTop:Responsive(150)}}>
                <TouchableOpacity onPress={()=>{wrongAnswer1(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor1, borderRadius:4, marginBottom:Responsive(9), padding:8}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(55), alignSelf:'center'}}>kâpaskâsink</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>{correctAnswer2(), playCorrectSound()}} style={{justifyContent:'center', backgroundColor:correctColor2, borderRadius:4, marginBottom:Responsive(9), padding:8}}>                    
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>išinihkâsoyan</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>{wrongAnswer2(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor2, borderRadius:4, marginBottom:Responsive(9), padding:8}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Môsonîwi</Text>
                </TouchableOpacity>                
            </View>
        </View>}
        {trackQuestions.three && <View>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(10)}}>
                ...
                <TextInput editable={false} style={{marginHorizontal:Responsive(8),
                                                    ...
                                                    backgroundColor:'#DADADA',
                                                    textAlign:'center',
                                                    borderRadius: 4, color: 'green'}} value={'išinihkâsoyan'}/>
                <Text style={{color:'gray', marginTop:Responsive(7)}}>?</Text>                                  
            </View>
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(10)}}>
                <Text style={{color:'gray', marginTop:Responsive(7), fontSize:18}}>Ben</Text>  
                <TextInput editable={false} style={{marginHorizontal:Responsive(8),
                                                    width: 150,
                                                    height: 35,
                                                    backgroundColor:'#DADADA',
            ...
            <View style={{alignSelf:'center', marginTop:Responsive(140)}}>
                <TouchableOpacity onPress={()=>{wrongAnswer1(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor1, borderRadius:4, marginBottom:Responsive(9), padding:8}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(55), alignSelf:'center'}}>Nešta kîla?</Text>
                </TouchableOpacity>                
                <TouchableOpacity onPress={()=>{wrongAnswer2(), playWrongSound()}} style={{justifyContent:'center', backgroundColor:questionColor2, borderRadius:4, marginBottom:Responsive(9), padding:8}}>                    
          ...
          <View style={{flexDirection:'row', alignSelf:'center'}}>              
            ...
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(10)}}>
                ...
                <TextInput editable={false} style={{marginHorizontal:Responsive(8),
                                                    ...
                                                    backgroundColor:'#DADADA',
                                                    textAlign:'center',
                                                    borderRadius: 4, color: 'green'}} value={'nitišinihkâson'}/>                                     
            </View>
        </View>}
