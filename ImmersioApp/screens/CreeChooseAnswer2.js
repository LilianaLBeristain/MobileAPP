  ...
  return (
    ...
    <SafeAreaView style={main.safeAreaContainer}>
      <View style={{height:'8%',
        ...
        <TouchableOpacity 
            onPress={()=>{ navigation.navigate("wâciye") }}>
            <Image 
        ...
        {trackQuestions.one && <View>
            <View style={{alignSelf:'center', marginTop:Responsive(110)}}>
                <TouchableOpacity onPress={()=>{ wrongAnswer1(), playWrongSound() }}
                    ...
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Agreeing</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>{correctAnswer1(),playCorrectSound()}}
                    ...
                    shadowRadius: 2,
                    elevation: 8,}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(8), alignSelf:'center'}}>Greeting or leaving</Text>
                </TouchableOpacity>         
            </View>
        </View>}
      </View>
