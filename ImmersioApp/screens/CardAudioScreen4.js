...
function App() {
  ...
  var lessonIntroImage = '../assets/Cree/kila.png'
  var explanation1 = "Kîla = you"
  var explanation2 = ""
  ...
  async function playSound() {
    ...
    const {sound} = await Audio.Sound.createAsync(require('../assets/Cree/kila.mp3'));
    setSound(sound);
