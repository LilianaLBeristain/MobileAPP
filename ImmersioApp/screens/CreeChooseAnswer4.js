  ...
  return (
    ...
    <SafeAreaView style={main.safeAreaContainer}>
      <View style={{height:'8%',
        ...
        <TouchableOpacity 
            onPress={()=>{ navigation.navigate("What is your name?") }}>
            <Image 
        ...
        {trackQuestions.one && <View>
            <View style={{alignSelf:'center', marginTop:Responsive(110)}}>
                <TouchableOpacity onPress={()=>{correctAnswer1(),playCorrectSound()}}
                    ...
                    shadowRadius: 2,
                    elevation: 8,}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(8), alignSelf:'center'}}>Jack nitišinihkâson</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={()=>{ wrongAnswer1(), playWrongSound() }}
                    ...
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Nitišinihkâson Jack</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={()=>{ wrongAnswer1(), playWrongSound() }}
                    ...
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>Jack nitôhcîn?</Text>
                </TouchableOpacity>         
            </View>
        </View>}
      </View>
    ...
    <View style={{marginTop: 170}}>
      <Text style={{color:'#FD6100', alignSelf:'center', marginTop: 50, fontSize:16, paddingVertical:Responsive(12), fontWeight: 'bold'}}>
