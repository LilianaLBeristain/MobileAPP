...
function App() {
  ...
  var lessonIntroImage = '../assets/Cree/nesta.png'
  var explanation1 = "Nešta = and"
  ...
  async function playSound() {
    ...
    const {sound} = await Audio.Sound.createAsync(require('../assets/Cree/nesta.mp3'));
    setSound(sound);
