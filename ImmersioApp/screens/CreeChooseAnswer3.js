  ...
  return (
    ...
    <SafeAreaView style={main.safeAreaContainer}>
      <View style={{height:'8%',
        ...
        <TouchableOpacity 
            onPress={()=>{ navigation.navigate("nitišinihkâson") }}>
            <Image 
        ...
        {trackQuestions.one && <View>
            <View style={{alignSelf:'center', marginTop:Responsive(110)}}>
                ...
                <TouchableOpacity onPress={()=>{correctAnswer1(),playCorrectSound()}}
                    ...
                    shadowRadius: 2,
                    elevation: 8,}}>
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), marginHorizontal:Responsive(8), alignSelf:'center'}}>tâni e-išinihkâsoyan?</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={()=>{ wrongAnswer1(), playWrongSound() }}
                    style={{justifyContent:'center', backgroundColor:questionColor1, borderRadius:4, marginBottom:Responsive(9), width: 250, height: 38,
                    shadowColor: "gray",
                    ...
                    <Text style={{color:'#956424', fontWeight:'bold', marginVertical:Responsive(6), alignSelf:'center'}}>tâni nitišinihkâson?</Text>
                </TouchableOpacity>         
            </View>
        </View>}
      </View>
