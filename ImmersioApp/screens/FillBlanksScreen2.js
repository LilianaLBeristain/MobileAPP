...
function FillBlanksScreen2() {
  ...
  const answers = {oneAnswer1:"imperium",
    oneAnswer2:"In",
    oneAnswer3:"est",
    twoAnswer1:"Estne",
    twoAnswer2:"in Africa",
    twoAnswer3:"in Āfrica",
    threeAnswer1:'Quid',
    threeAnswer2:'Ecce',
    fourAnswer1:'Imperium',
    fourAnswer2:'et in'}
  ...
  <SafeAreaView style={main.safeAreaContainer}>
    <View style={{height:'6%',
      ...
      <TouchableOpacity onPress={()=>{
        ...
        {trackQuestions.done && <TouchableOpacity onPress={()=>{
              _storeData('done');
              navigation.navigate("Have a conversation")
              }}>
          <Image 
            source={require('../assets/TriangleRight.png')}
            resizeMode='contain' style={{marginVertical:(3)}}/>
    ...
    {/* <Modal animationType="fade" transparent visible={modalVisible}>
      ...
      <Modal animationType="fade" transparent visible={modalVisible2}>
        ...
        <Text style={{color:'#363130', alignSelf:'center', fontWeight:'bold', fontSize:16, paddingVertical:Responsive(12), marginTop:Responsive(10)}}>
            Complete the sentences in order:
        </Text>
        {trackQuestions.one && <View>
            <View style={{flexDirection:'row', alignSelf:'center'}}>
              <Text style={{color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>Ecce, est</Text>
               <TextInput maxLength={11} editable={true} onChangeText={(text)=>setTemp1(text)} autoCorrect={false} style={{marginHorizontal:Responsive(6),
                                                    width: 70,
                                                    height: 20,
                                                    borderWidth: 0.3,
                                                    alignSelf:'center',
                                                    ...
                                                    textAlign:'center'}}/>    
                <Text style={{color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>Romanum.</Text>
                </View>
              <View style={{flexDirection:'row', alignSelf:'center'}}>
                <TextInput maxLength={5} editable={true} onChangeText={(text)=>setTemp2(text)} autoCorrect={false} style={{marginHorizontal:Responsive(6),
                                                    width: 35,
                                                    height: 20,
                                                    borderWidth: 0.3,
                                                    alignSelf:'center',
                                                    ...
                                                    fontSize:Responsive(13),
                                                    textAlign:'center'}}/>    
                <Text style={{color:'gray', marginTop:Responsive(12), fontSize:Responsive(13)}}>Asia et in Eurōpa et in Āfrica</Text>
                <TextInput maxLength={6} editable={true} onChangeText={(text)=>setTemp3(text)} autoCorrect={false} style={{marginLeft:Responsive(6),
                                                    width: 35,
                                                    height: 20,
                                                    borderWidth: 0.3,
                                                    alignSelf:'center',
                                                    ...
                                                    fontSize:Responsive(13),
                                                    textAlign:'center'}}/>   
                <Text style={{color:'gray', marginTop:Responsive(12), fontSize:Responsive(13)}}>.</Text>
                {(!(temp1.toLowerCase() === answers.oneAnswer1.toLowerCase()) || !(temp2.toLowerCase() === answers.oneAnswer2.toLowerCase()) || !((temp3.toLowerCase() === answers.oneAnswer3.toLowerCase()))) && <TouchableOpacity onPress={()=>{setTrackQuestions({one:false,two:true}), playWrongSound()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(9), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
                </TouchableOpacity>}
                {((temp1.toLowerCase() === answers.oneAnswer1.toLowerCase()) && (temp2.toLowerCase() === answers.oneAnswer2.toLowerCase()) && ((temp3.toLowerCase() === answers.oneAnswer3.toLowerCase()))) && <TouchableOpacity onPress={()=>{setOneAnswer(true),setCorrectAnswers({count:correctAnswers.count+1}),setTrackQuestions({one:false,two:true}),playCorrectSound()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(9), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
        ...
        {trackQuestions.two && <View>
          <View style={{flexDirection:'row', alignSelf:'center', maxWidth:'80%'}}>
                <Text style={{textAlign:'center', color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>Ecce, est imperium Romanum. In Asia et in Eurōpa et in Āfrica est.</Text>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(10)}}>
              <TextInput maxLength={8} editable={true} onChangeText={(text)=>setTemp1(text)} autoCorrect={false} style={{marginRight:Responsive(5),
                                                    ...
                                                    fontSize:Responsive(13),
                                                    textAlign:'center'}}/>  
                <Text style={{color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>Āfrica? Est.</Text>
                <TextInput maxLength={12} editable={true} onChangeText={(text)=>setTemp2(text)} autoCorrect={false} style={{marginHorizontal:Responsive(6),
                                                    width: 75,
                                                    height: 20,
                                                    borderWidth: 0.3,
                                                    alignSelf:'center',
                                                    ...
                                                    fontSize:Responsive(13),
                                                    textAlign:'center'}}/>  
                <Text style={{color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>est.</Text> 
              </View>
              <View style={{flexDirection:'row', alignSelf:'center'}}>
                <Text style={{color:'gray', marginTop:Responsive(6), fontSize:Responsive(13)}}>Estne imperium Romanum in Āfrica? Est.</Text>
                {(!(temp1.toLowerCase() === answers.twoAnswer1.toLowerCase()) || !((temp2.toLowerCase() === answers.twoAnswer2.toLowerCase()) || (temp2.toLowerCase() === answers.twoAnswer3.toLowerCase()))) && <TouchableOpacity onPress={()=>{setTrackQuestions({one:false,two:false,three:true}), playWrongSound()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(3), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
                </TouchableOpacity>}
                {((temp1.toLowerCase() === answers.twoAnswer1.toLowerCase()) && ((temp2.toLowerCase() === answers.twoAnswer2.toLowerCase()) || (temp2.toLowerCase() === answers.twoAnswer3.toLowerCase()))) && <TouchableOpacity onPress={()=>{setTwoAnswer(true),setCorrectAnswers({count:correctAnswers.count+1}),setTrackQuestions({two:false,three:true}), playCorrectSound()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(3), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
        ...
        {trackQuestions.three && <View>
          <View style={{flexDirection:'row', alignSelf:'center', maxWidth:'80%'}}>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', maxWidth:'80%'}}>
                <Text style={{textAlign:'center', color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>Estne Āfrica? Est. In Āfrica est. Estne imperium Romanum in Āfrica? Est.</Text>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(8)}}>
                
                <TextInput maxLength={7} editable={true} onChangeText={(text)=>setTemp1(text)} autoCorrect={false} style={{marginRight:Responsive(5),
                                                    ...
                                                    textAlign:'center'}}/>  
                <Text style={{color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>est?</Text>
                <TextInput maxLength={6} editable={true} onChangeText={(text)=>setTemp2(text)} autoCorrect={false} style={{marginLeft:Responsive(6),
                                                    width: 45,
                                                    height: 20,
                                                    borderWidth: 0.3,
                                                    alignSelf:'center',
                                                    ...
                                                    fontSize:Responsive(13),
                                                    textAlign:'center'}}/>  
                <Text style={{color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>, est imperium Romanum.</Text>
                {(!(temp1.toLowerCase() === answers.threeAnswer1.toLowerCase()) || !(temp2.toLowerCase() === answers.threeAnswer2.toLowerCase())) && <TouchableOpacity onPress={()=>{setTrackQuestions({one:false,three:false,four:true}), playWrongSound()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(15), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
                </TouchableOpacity>}
                {((temp1.toLowerCase() === answers.threeAnswer1.toLowerCase()) && (temp2.toLowerCase() === answers.threeAnswer2.toLowerCase())) && <TouchableOpacity onPress={()=>{setThreeAnswer(true),setCorrectAnswers({count:correctAnswers.count+1}),setTrackQuestions({one:false,three:false,four:true}), playCorrectSound()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(15), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
        ...
        {trackQuestions.four && <View>
          <View style={{flexDirection:'row', alignSelf:'center', maxWidth:'80%'}}>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', maxWidth:'80%'}}>
                <Text style={{textAlign:'center', color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>Quid est? Ecce, est imperium Romanum.</Text>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', marginTop:Responsive(8)}}>
                ...
                <TextInput maxLength={11} editable={true} onChangeText={(text)=>setTemp1(text)} autoCorrect={false} style={{marginRight:Responsive(5),
                                                    marginRight:Responsive(3),
                                                    width: 75,
                                                    height: 20,
                                                    borderWidth: 0.3,
                                                    ...
                                                    fontSize:Responsive(13),
                                                    textAlign:'center'}}/>  
                <Text style={{color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>est in Asia, in Eurōpa,</Text>
                {(!(temp1.toLowerCase() === answers.fourAnswer1.toLowerCase()) || !(temp2.toLowerCase() === answers.fourAnswer2.toLowerCase())) && <TouchableOpacity onPress={()=>{setTrackQuestions({one:false,three:false,done:true}), playWrongSound()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(15), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
                </TouchableOpacity>}
                {((temp1.toLowerCase() === answers.fourAnswer1.toLowerCase()) && (temp2.toLowerCase() === answers.fourAnswer2.toLowerCase())) && <TouchableOpacity onPress={()=>{setFourAnswer(true),setCorrectAnswers({count:correctAnswers.count+1}),setTrackQuestions({one:false,four:false,done:true}), playExerciseComplete()}}>
                  <Image 
                    style={{alignSelf:'center' ,width: 22, height: 22, marginTop:Responsive(15), marginLeft:Responsive(8)}}
                    source={require('../assets/play-24.png')}
                    resizeMode='contain' />
                ...
                <TextInput maxLength={8} editable={true} onChangeText={(text)=>setTemp2(text)} autoCorrect={false} style={{marginHorizontal:Responsive(6),
                                                    ...
                                                    fontSize:Responsive(13),
                                                    textAlign:'center'}}/>  
                <Text style={{color:'gray', marginTop:Responsive(8), fontSize:Responsive(13)}}>Āfrica.</Text>
            </View>
        </View>}
        {trackQuestions.done && <View>
          <View style={{flexDirection:'row', alignSelf:'center', maxWidth:'80%'}}>
            ...
            <View style={{flexDirection:'row', alignSelf:'center', maxWidth:'80%'}}>
                <Text style={{textAlign:'center', color:'gray', marginTop:Responsive(16), fontSize:Responsive(13)}}>Imperium est in Asia, in Eurōpa, et in Āfrica.</Text>
...
export default FillBlanksScreen2;
